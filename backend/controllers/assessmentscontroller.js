...
const registerAssessment = (req, res) => {
    const { subject_id,title,type,due_date,weight,difficulty,estimated_hours } = req.body;
...
const updateAssessment = (req, res) => {
    const { subject_id,old_title,title,type,due_date,weight,difficulty,estimated_hours } = req.body;
    const student_id = req.student_id;
...
const getUpcomingAssessments = (req, res) => {
    ...
    WHERE assessments.student_id = ? AND assessments.due_date >= CURDATE() ORDER BY assessments.due_date ASC`;
...
const filterassessments = (req, res) => {
    const { subject_id,filter } = req.body;
    const student_id = req.student_id;
